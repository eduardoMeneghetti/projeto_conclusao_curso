...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference("Atividade.count") do
      post atividades_url, params: { atividade: { ativo: @atividade.ativo, cor: @atividade.cor, descricao: @atividade.descricao } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { ativo: @atividade.ativo, cor: @atividade.cor, descricao: @atividade.descricao } }
