...
class InsumosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insumo" do
    assert_difference("Insumo.count") do
      post insumos_url, params: { insumo: { ativo: @insumo.ativo, descricao: @insumo.descricao, principios_ativo_id: @insumo.principios_ativo_id, semente: @insumo.semente, unidades_medida_id: @insumo.unidades_medida_id } }
    end
  ...
  test "should update insumo" do
    patch insumo_url(@insumo), params: { insumo: { ativo: @insumo.ativo, descricao: @insumo.descricao, principios_ativo_id: @insumo.principios_ativo_id, semente: @insumo.semente, unidades_medida_id: @insumo.unidades_medida_id } }
