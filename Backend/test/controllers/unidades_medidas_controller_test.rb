...
class UnidadesMedidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidades_medida" do
    assert_difference("UnidadesMedida.count") do
      post unidades_medidas_url, params: { unidades_medida: { descrcicao: @unidades_medida.descrcicao } }
    end
  ...
  test "should update unidades_medida" do
    patch unidades_medida_url(@unidades_medida), params: { unidades_medida: { descrcicao: @unidades_medida.descrcicao } }
