...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference("Cidade.count") do
      post cidades_url, params: { cidade: { codigo_ibge: @cidade.codigo_ibge, descricao: @cidade.descricao, estado_id: @cidade.estado_id, latitude: @cidade.latitude, longitude: @cidade.longitude } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { codigo_ibge: @cidade.codigo_ibge, descricao: @cidade.descricao, estado_id: @cidade.estado_id, latitude: @cidade.latitude, longitude: @cidade.longitude } }
